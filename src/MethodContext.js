...
export const obj = {
    ...
    subscribe() {
        this.incrementBinded = this.increment.bind(this);
        EventEmitter.on('click', this.incrementBinded);
    },
    unsubscribe() {
        EventEmitter.off('click', this.incrementBinded);
    },
};
...
export const obj1 = {
    first(...args) {
        this.second.apply(null, args.reverse());
    },
    second() {
